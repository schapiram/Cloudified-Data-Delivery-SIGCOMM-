...
\begin{comment}
\begin{figure}[t!]
  \subfloat[\label{fig:e2e-traffic}Using AWS relays]{\includegraphics[width=0.2\textwidth]{figures/overlay-vs-e2e.001.png}}
  \subfloat[ \label{fig:cloud-traffic} Using AWS relays]{\includegraphics[width=0.2\textwidth]{figures/overlay-vs-e2e.002.png}}
\caption{\label{fig:e2e-vs-cloud-traffic} Server A is sending data to client A}
\end{figure}
\end{comment}
%%%%%%%%%
